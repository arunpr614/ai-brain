...
import { confirmEnrollmentJob } from "@/db/processing-enrollment";
import { enrollmentConfirmSchema, enrollmentJobIdSchema } from "@/lib/processing/contracts";
...
export async function POST(req: NextRequest, context: Context) {
  ...
  try {
    ...
    const result = confirmEnrollmentJob(jobId, enrollmentConfirmSchema.parse(await readBoundedJson(req)));
