      ...
      <header className="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="flex flex-wrap items-center gap-2">
          {needsUpgradeCount > 0 && (
            <Link
              href="/needs-upgrade"
              className="inline-flex h-11 items-center gap-2 rounded-md border border-[var(--quality-needs-upgrade)] bg-[var(--surface-raised)] px-3 text-sm font-medium text-[var(--quality-needs-upgrade)] transition-colors duration-[var(--duration-fast)] hover:bg-[var(--surface)] md:h-9"
            >
          ...
          <Link
            href="/capture"
            className="inline-flex h-11 items-center gap-2 rounded-md bg-[var(--action-primary-bg)] px-4 text-sm font-medium text-[var(--action-primary-fg)] transition-colors duration-[var(--duration-fast)] hover:bg-[var(--action-primary-bg-hover)] md:h-9"
          >
      ...
      <form action="/search" method="get" className="mb-6">
        <div className="relative">
          ...
          <input
            ...
            className="h-11 w-full rounded-md border border-[var(--border)] bg-[var(--surface-raised)] py-2 pl-9 pr-3 text-sm text-[var(--text-primary)] placeholder:text-[var(--text-muted)] md:h-9"
          />
        </div>
      </form>
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            {filteredCount > 0 && (
              <Link
                ...
                className="inline-flex h-8 items-center gap-1.5 rounded-md bg-[var(--action-primary-bg)] px-3 text-sm font-medium text-[var(--action-primary-fg)] hover:bg-[var(--action-primary-bg-hover)]"
              >
...
function EmptyState() {
  return (
    <div className="flex flex-col items-center justify-center rounded-lg border border-dashed border-[var(--border)] bg-[var(--surface)] px-6 py-16 text-center">
      ...
      <Link
        href="/capture"
        className="mt-6 inline-flex h-11 items-center gap-2 rounded-md bg-[var(--action-primary-bg)] px-4 text-sm font-medium text-[var(--action-primary-fg)] transition-colors duration-[var(--duration-fast)] hover:bg-[var(--action-primary-bg-hover)] md:h-9"
      >
        <Plus className="h-4 w-4" strokeWidth={2} />
        Capture
      </Link>
