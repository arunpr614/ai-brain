          ...
          >
            <div className="mb-4 flex items-start justify-between gap-3">
              ...
              <button
                type="button"
                onClick={() => setOpen(false)}
                className="inline-flex h-8 w-8 items-center justify-center rounded-md border border-[var(--border)] text-[var(--text-secondary)] hover:text-[var(--text-primary)]"
                aria-label="Close filters"
              >
            ...
            <div className="space-y-4">
              ...
              {activeFilterLabels.length > 0 && (
                <Link
                  href="/library"
                  className="inline-flex h-9 w-full items-center justify-center rounded-md border border-[var(--border)] px-3 text-sm font-medium text-[var(--text-primary)] hover:bg-[var(--surface-raised)]"
                >
                  Clear filters
                </Link>
              )}
      ...
      <div className="grid grid-cols-2 gap-2">
        {options.map((option) => (
          <Link
            ...
            className={`inline-flex h-9 items-center justify-center rounded-md border px-3 text-sm font-medium transition-colors duration-[var(--duration-fast)] ${
              option.active
