    ...
    <main id="handoff-main" className="handoff-main" tabIndex="-1">
      ...
      <section className="handoff-section">
        ...
        <ol className="pickup-steps">
          ...
          <li><span>3</span><div><strong>Run only the isolated prototype</strong><p>No production application change is part of this handoff.</p><CopyCommand>cd "/Users/arun.prakash/Documents/arunvault/arun-cursor/Initiatives/Arun_AI_Projects/ai-brain/Phase3/Kanban-designs/prototypes" &amp;&amp; npm ci &amp;&amp; npm run dev -- --host 127.0.0.1 --port 4173</CopyCommand></div></li>
          ...
          <li><span>5</span><div><strong>Re-run the local package gate after any change</strong><CopyCommand>cd "/Users/arun.prakash/Documents/arunvault/arun-cursor/Initiatives/Arun_AI_Projects/ai-brain/Phase3/Kanban-designs/prototypes" &amp;&amp; npm run build</CopyCommand><p>Run <code>npm run check:agent-docs</code> separately from an AI Brain repository worktree when repository documentation is changed.</p></div></li>
        </ol>
      </section>
