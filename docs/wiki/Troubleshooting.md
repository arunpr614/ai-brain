...
| NotebookLM connector setup fails | extension 0.7.0 load state, scoped pairing, optional permission, exact origin/protocol | release artifact not loaded, code expired, permission absent, connector unpaired | Tokens, notebook URL, account route, or raw identifiers would enter evidence |
