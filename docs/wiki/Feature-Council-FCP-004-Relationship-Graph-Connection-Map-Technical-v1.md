...
> **Superseded planning draft - do not implement.** Use the later planning successor: [Feature-Council-FCP-004-Relationship-Graph-Connection-Map-Technical-v2](Feature-Council-FCP-004-Relationship-Graph-Connection-Map-Technical-v2). Then check the living [Feature Catalog](Feature-Catalog) for present status.
