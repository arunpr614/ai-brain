...
> **Historical draft - do not implement.** Use the current successor: [Feature-Council-FCP-002-Source-Workspace-Reading-Studio-Lite-PRD-v2](Feature-Council-FCP-002-Source-Workspace-Reading-Studio-Lite-PRD-v2).
