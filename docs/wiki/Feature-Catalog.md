...
| Card Processing Workflow | Explored | Not available | High proposal; no runtime | No runtime claim; fictional prototype only | [Exploration](Card-Processing-Workflow-Exploration) | `1cb5d36…` exploration baseline | Dedicated Processing lifecycle is proposed, **not implemented** |
