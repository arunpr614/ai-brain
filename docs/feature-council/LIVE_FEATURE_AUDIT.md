...
Version: v2 after `CORE_ARTIFACTS_V1_ADVERSARIAL_REVIEW_2026-06-28_21-23-55_IST.md`
...
| Deployment | Hetzner service behind Cloudflare tunnel with authenticated release health checks | `scripts/deploy.sh`, `scripts/deploy/brain.service`, `README.md` |
| Mobile | Capacitor Android thin WebView loading `https://brain.arunp.in`; offline fallback only | `capacitor.config.ts`, `android/*`, `public/offline.html` |
...
- Native dependencies are repaired on Hetzner after sync.
