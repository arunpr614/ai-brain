...
| Dedicated test notebook | Required before live spikes | Pending eligibility |
...
| Privacy boundary disclosed | Security/privacy assessment | Research complete; product UX pending gate |
...
| Wiki contains publication-safe status | Canonical Wiki sources and remote verification | Repository draft passes privacy/structure checks; live publication pending |
| Review-only PR; no merge | Delivery checklist | Pending |
